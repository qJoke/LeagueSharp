    ...
    class Italian : IVHRLanguage
    {
        ...
        public Dictionary<string, string> GetTranslations()
        {
            var translations = new Dictionary<string, string>
            {
                ...
                {"dz191.vhr.misc.condemn.lowlifepeel", "AutoPeel con Condsnna quando hai poca vita"},
                {"dz191.vhr.misc.condemn.noeturret", "Non usare Condanna sotto la torre nemica"},
                {"dz191.vhr.misc.general.antigp", "Anti-Abilita' di avvicinamento"},
                {"dz191.vhr.misc.general.interrupt", "Interruttore"},
                {"dz191.vhr.misc.general.antigpdelay", "Anti-Abilita' di avvicinamento (ms)"},
