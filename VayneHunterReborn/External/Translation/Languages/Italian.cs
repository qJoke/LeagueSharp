    ...
    class Italian : IVHRLanguage
    {
        ...
        public Dictionary<string, string> GetTranslations()
        {
            var translations = new Dictionary<string, string>
            {
                ...
                {"dz191.vhr.farm.qjungle", "Usa Q contro mostri in giungla"},
                {"dz191.vhr.misc.condemn.qlogic", "Logica della Q"},
                {"dz191.vhr.mixed.mirinQ", "Q sui Muri quando possibile (Mirin Mode)"},
                {"dz191.vhr.misc.tumble.smartq", "Prova Q->E quando possibile"},
                {"dz191.vhr.misc.tumble.noaastealthex", "Non attaccare da invisibile"},
                {"dz191.vhr.misc.tumble.noqenemies", "Non usare Q addosso ai nemici"},
                {"dz191.vhr.misc.tumble.dynamicqsafety", "Usa distanza dinamica di sicurezza per Q"},
